...
export function initToolbar(container) {
  ...
  actions.querySelector("#btn-undo").addEventListener("click", () => editorStore.getState().undo());
  actions.querySelector("#btn-redo").addEventListener("click", () => editorStore.getState().redo());
